...
"""visualise_result.py: Visualise the binning result from on the SPAdes assembly graph.
...
# Sample command
# -------------------------------------------------------------------
# python visualise_result.py  --initial /path/to/file_with_initial_binning_result
